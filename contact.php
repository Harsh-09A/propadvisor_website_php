      ...
      <div class="container">
        <div
          ...
          <div
            ...
            <span
              class="ps-25px pe-25px pt-5px pb-5px mb-15px text-uppercase text-base-color fs-12 ls-1px fw-600 border-radius-100px bg-gradient-dark-gray-transparent d-flex"
      ...
      <div class="container">
        ...
        <div
          ...
          <div class="col md-mb-30px text-center text-sm-start">
            <span
              class="alt-font fs-18 fw-700 d-block w-90 text-base-color border-bottom border-2 border-color-dark-gray pb-15px mb-15px xs-w-100"
              ><i
                class="feather icon-feather-map-pin d-inline-block icon-small me-10px"></i
          ...
          <div class="col md-mb-30px text-center text-sm-start">
            <span
              class="alt-font fs-18 fw-700 d-block w-90 border-bottom border-2 border-color-dark-gray pb-15px mb-15px xs-w-100 text-base-color"
              ><i
                class="feather icon-feather-mail d-inline-block icon-small me-10px"></i
              >Send a message</span
            >
            <a href="mailto:info@propadvisor.com">info@propadvisor.co.in</a
            ><br />
          ...
          <div class="col xs-mb-30px text-center text-sm-start">
            <span
              class="alt-font fs-18 fw-700 d-block w-90 text-base-color border-bottom border-2 border-color-dark-gray pb-15px mb-15px xs-w-100"
              ><i
                class="feather icon-feather-phone d-inline-block icon-small me-10px"></i
          ...
          <div class="col text-center text-sm-start">
            <span
              class="alt-font fs-18 fw-700 d-block w-90 text-base-color border-bottom border-2 border-color-dark-gray pb-15px mb-15px xs-w-100"
              ><i
                class="feather icon-feather-users d-inline-block icon-small me-10px"></i
              >Join our team</span
            >
            <a href="mailto:hire@propadvisor.co.in">hire@propadvisor.co.in</a
            ><br />
