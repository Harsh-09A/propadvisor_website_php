...
<html class="no-js" lang="en">
  ...
  <body
      ...
      <div
        ...
        <div class="swiper-wrapper">
          ...
          <div
            ...
            style="
              background-image: url('img/properties/Project_Delta_Prestige.jpg');
            ">
            <div class="container h-100">
              <div class="row align-items-center h-100">
                <div
                  ...
                  <span class="fs-20 d-block mb-15px">Pushpak Nagar</span>
                  <div
            ...
            <div
              class="position-absolute col-xxl-5 col-lg-6 right-0px bottom-0px pt-50px pb-40px ps-40px pe-40px lg-p-35px d-none d-lg-inline-block bg-white border-radius-left-8px"
              ...
              <div class="row justify-content-center">
                <div class="col-xl-7 lg-mb-25px">
                  <div class="row">
                    <div
                      class="col text-center border-end border-color-extra-medium-gray">
                      <img
                        class="mb-5px h-50px"
                        src="img/icons/real-estate-icon-bed.svg"
                        alt="" />
                    ...
                    <div
                      ...
                      <img
                        class="mb-5px h-50px"
                        src="img/icons/real-estate-icon-bath.svg"
                        alt="" />
                      <span class="alt-font fs-16 fw-500 d-block">3 Baths</span>
                    </div>
                    <div
                      class="col text-center border-end lg-border-end-0 border-color-extra-medium-gray">
                      <img
                        class="mb-5px h-50px"
                        src="img/icons/real-estate-icon-car.svg"
                        alt="" />
                      <span class="alt-font fs-16 fw-500 d-block"
                        >4 Parking</span
                      >
                    </div>
                  </div>
                ...
                <div
                  class="col-xl-5 ps-35px lg-ps-15px text-center text-xl-start">
                  <span class="fw-500 mb-5px d-block alt-font"
                    >For sell price</span
                  >
                  <h4 class="text-dark-gray fw-700 alt-font mb-0 ls-minus-1px">
                    ₹30 Lakhs
                  </h4>
                </div>
              </div>
          ...
          <div
            class="swiper-slide cover-background"
            style="
              background-image: url('img/properties/Project_Invicta_Ulve.jpg');
            ">
            <div class="container h-100">
              <div class="row align-items-center h-100">
                <div
                  class="col-md-8 position-relative text-white"
                  data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                  <span class="fs-20 d-block mb-15px">Ulwe</span>
                  <div
                    class="alt-font fs-110 lg-fs-90 lh-90 lg-lh-80 mb-45px sm-mb-25px w-80 xs-w-100 ls-minus-2px">
          ...
          <div
            class="swiper-slide cover-background"
            style="
              background-image: url('img/properties/Project_Invicta_Ecalt.jpg');
            ">
            <div class="container h-100">
              <div class="row align-items-center h-100">
                <div
        ...
        <div class="container">
          <div class="row g-0">
            <div class="col-12 position-relative">
              <!-- start slider pagination -->
              <div
                class="swiper-pagination left-0 text-start swiper-pagination-clickable swiper-number fs-14 alt-font ls-05px"></div>
        ...
        <div class="row align-items-center justify-content-center">
          <div
            ...
            <figure
              ...
              <img
                src="img/projects/projects_banner_600x800.jpg"
                alt=""
                class="w-100" />
              <figcaption
                class="position-absolute border-radius-left-8px bg-base-color right-0px bottom-0px p-45px last-paragraph-no-margin">
                <i
                  class="feather icon-feather-home icon-medium text-white mb-15px d-block"></i>
                <h4 class="alt-font fw-700 text-white mb-0 d-block">500+</h4>
                <p class="text-white">Properties listed for Sale</p>
              </figcaption>
            </figure>
          </div>
          <div
            ...
            >
            <h2
              class="alt-font fw-500 text-dark-gray ls-minus-1px shadow-none sm-w-85"
              data-shadow-animation="true"
              data-animation-delay="700">
              We help you find your
              <span class="fw-700 text-highlight"
                >new place.<span
                  class="bg-base-color h-10px bottom-10px opacity-3 separator-animation"></span
              ></span>
            </h2>
            <p class="w-80 md-w-100">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam qui
              delectus unde veniam quaerat vero provident architecto nam
            ...
            <div class="mb-35px">
                ...
                <div
                  ...
                  <div class="feature-box-content">
                    <span class="text-dark-gray"
                      >More than 10 years of experience.</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="icon-with-text-style-08">
                <div
                  ...
                  <div class="feature-box-content">
                    <span class="text-dark-gray"
                      >10,000+ people trusting our agency.</span
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="d-inline-block">
              <!-- <a
                href="about.html"
                class="btn btn-dark-gray btn-medium btn-round-edge me-25px"
                >About company</a
              >
              <a
                href=""
              ...
              <a
                ...
                <span>
                  ...
                  <span class="btn-double-text" data-text="Find property"
                    >Find property</span
                  >
                </span>
              </a>
    ...
    <section class="p-0 border-top border-color-extra-medium-gray">
      <div class="container">
        <div
          class="row row-cols-1 row-cols-lg-6 row-cols-md-3 row-cols-sm-2 justify-content-center g-0 bg-white"
          ...
          <div
            ...
            <span
              ...
              data-animation-delay="700"
              >What are you
              <span class="fw-600 text-highlight"
                >looking<span
                  class="bg-base-color h-6px bottom-3px opacity-3 separator-animation"></span
              ></span>
              for?</span
            >
          </div>
          ...
          <div
            ...
            <div class="feature-box pt-45px pb-25px">
              <div class="feature-box-icon mb-10px">
                <div
                  class="text-uppercase alt-font fw-700 text-white fs-12 lh-22 bg-base-color-transparent border-radius-4px position-absolute left-18px top-18px ps-10px pe-10px">
                  20K
                </div>
                <a href="" class="d-block">
                  <img src="img/icons/real-estate-icon-apartment.svg" alt="" />
                </a>
              </div>
              <div class="feature-box-content">
                <a
                  href=""
                  class="alt-font text-dark-gray text-dark-gray-hover fw-700 fs-15 lh-20 text-uppercase"
                  >Apartment</a
                >
              </div>
            </div>
          ...
          <!-- <div
            ...
            <div class="feature-box pt-45px pb-25px">
              <div class="feature-box-icon mb-10px">
                ...
                <a href="" class="d-block">
                  <img
                    src="img/icons/real-estate-icon-condominium.svg"
                    alt="" />
                </a>
              </div>
              <div class="feature-box-content">
          ...
          <div
            ...
            <div class="feature-box pt-45px pb-25px">
              <div class="feature-box-icon mb-10px">
                ...
                <a href="" class="d-block">
                  <img src="img/icons/real-estate-icon-home.svg" alt="" />
                </a>
              </div>
              <div class="feature-box-content">
                <a
          ...
          <div
            ...
            <div class="feature-box pt-45px pb-25px">
              <div class="feature-box-icon mb-10px">
                ...
                <a href="" class="d-block">
                  <img src="img/icons/real-estate-icon-office.svg" alt="" />
                </a>
              </div>
              <div class="feature-box-content">
                <a
          ...
          <div
            ...
            <div class="feature-box pt-45px pb-25px">
              <div class="feature-box-icon mb-10px">
                ...
                <a href="" class="d-block">
                  <img src="img/icons/real-estate-icon-shop.svg" alt="" />
                </a>
              </div>
              <div class="feature-box-content">
                <a
          ...
          <div
            ...
            <h3
              ...
              <span class="fw-700 text-highlight d-inline-block"
                >Sale<span
                  class="bg-base-color h-10px bottom-1px opacity-3 separator-animation"></span
              ></span>
            </h3>
          </div>
          <div
        ...
        <div
          ...
          <div class="col mb-30px">
            <div class="border-radius-6px overflow-hidden box-shadow-large">
              <div class="image position-relative">
                <a href="">
                  <img src="img/properties/Projects_600x415_1.jpg" alt="" />
                </a>
                <div
              ...
              <div class="bg-white">
                <div
                  ...
                  <p class="mb-20px">New Panvel</p>
                  <div class="row g-0">
                    <div class="col">
                      <div class="d-flex align-items-center">
                        <img
                          src="img/icons/real-estate-icon-bed-small.svg"
                          class="me-5px h-20px"
                          alt="" />
                    ...
                    <div class="col">
                      <div class="d-flex align-items-center">
                        <img
                          src="img/icons/real-estate-icon-bath-small.svg"
                          class="me-5px h-20px"
                          alt="" />
                    ...
                    <div class="col">
                      <div class="d-flex align-items-center">
                        <img
                          src="img/icons/real-estate-icon-size-small.svg"
                          class="me-5px h-20px"
                          alt="" />
                        <span class="fw-600 alt-font text-dark-gray"
                          >360m<sup>2</sup></span
                        >
                      </div>
                ...
                <div
                  ...
                  <div class="col">
                    <a
                      href=""
                      class="btn btn-dark-gray btn-very-small btn-round-edge fw-600"
                      >View details</a
                    >
                  </div>
                  <div class="col text-end">
                    <span class="fs-24 alt-font text-dark-gray fw-700 mb-0"
                      >₹6,89,000</span
                    >
                  </div>
                </div>
          ...
          <div class="col mb-30px">
            <div class="border-radius-6px overflow-hidden box-shadow-large">
              <div class="image position-relative">
                <a href="">
                  <img src="img/properties/Projects_600x415_2.jpg" alt="" />
                </a>
                <div
                  class="col-auto bg-orange border-radius-50px ps-15px pe-15px text-uppercase alt-font fw-600 text-white fs-12 lh-24 position-absolute left-20px top-20px">
                  Hot
                </div>
              </div>
              <div class="bg-white">
                <div
                  ...
                  <p class="mb-20px">Pushpak Nagar</p>
                  <div class="row g-0">
                    <div class="col">
                      <div class="d-flex align-items-center">
                        <img
          ...
          <div class="col mb-30px">
            <div class="border-radius-6px overflow-hidden box-shadow-large">
              <div class="image position-relative">
                <a href="">
                  <img src="img/properties/Projects_600x415_3.jpg" alt="" />
                </a>
                <div
                  class="col-auto bg-base-color border-radius-50px ps-15px pe-15px text-uppercase alt-font fw-600 text-white fs-12 lh-24 position-absolute left-20px top-20px">
                  Trending
          ...
          <div class="col lg-mb-30px">
            <div class="border-radius-6px overflow-hidden box-shadow-large">
              <div class="image position-relative">
                <a href="">
                  <img src="img/properties/Projects_600x415_4.jpg" alt="" />
                </a>
                <div
                  class="col-auto bg-base-color border-radius-50px ps-15px pe-15px text-uppercase alt-font fw-600 text-white fs-12 lh-24 position-absolute left-20px top-20px">
                  Popular
          ...
          <div class="col sm-mb-30px">
            <div class="border-radius-6px overflow-hidden box-shadow-large">
              <div class="image position-relative">
                <a href="">
                  <img src="img/properties/Projects_600x415_5.jpg" alt="" />
                </a>
                <div
                  class="col-auto bg-orange border-radius-50px ps-15px pe-15px text-uppercase alt-font fw-600 text-white fs-12 lh-24 position-absolute left-20px top-20px">
                  Latest
          ...
          <div class="col">
            <div class="border-radius-6px overflow-hidden box-shadow-large">
              <div class="image position-relative">
                <a href="">
                  <img src="img/properties/Projects_600x415_6.jpg" alt="" />
                </a>
                <div
                  class="col-auto bg-base-color border-radius-50px ps-15px pe-15px text-uppercase alt-font fw-600 text-white fs-12 lh-24 position-absolute left-20px top-20px">
                  Exclusive
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center mb-7">
          <div
            ...
            <span class="fs-20 d-inline-block mb-15px text-base-color"
              >Why choose us our service</span
            >
            <h3
              ...
              <div class="icon-with-text-style-08 mb-30px">
                <div class="feature-box feature-box-left-icon overflow-hidden">
                  <div class="feature-box-icon">
                    <img
                      src="img/icons/home-icon-custom.png"
                      class="w-80px"
                      alt="" />
                  </div>
                  <div class="feature-box-content last-paragraph-no-margin">
                    <span
                      ...
                      >Most appreciated projects</span
                    >
              ...
              <div class="icon-with-text-style-08">
                <div class="feature-box feature-box-left-icon overflow-hidden">
                  ...
                  <div class="feature-box-content last-paragraph-no-margin">
                    <span
                      class="text-dark-gray fs-19 alt-font mb-5px fw-600 d-block"
                      >Highest rental income projects</span
                    >
                    <p class="w-80 lg-w-100">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Au
            ...
            <div class="d-inline-block">
              <a
                href=""
                class="btn btn-dark-gray btn-medium btn-round-edge me-15px xs-mb-10px"
                >Residential</a
              >
              <a
                href=""
                class="btn btn-medium btn-round-edge btn-transparent-light-gray border-1 fw-700 xs-mb-10px"
                >Commercial</a
              >
            </div>
          </div>
          <div
            ...
            <figure
              ...
              <img
                src="img/projects/project_page_img.jpg"
                ...
                <span>
                  <span class="video-icon bg-white">
                    ...
                    <span class="video-icon-sonar">
                      <span
                        class="video-icon-sonar-bfr border border-color-white"></span>
                    </span>
                  </span>
                </span>
              </a> -->
              <figcaption
                ...
                <h1
                  class="mx-auto mb-0 fw-700 alt-font text-dark-gray mb-5px mt-25px">
                  4.9
                </h1>
                ...
                <span
                  class="text-dark-gray text-uppercase fs-13 fw-700 alt-font mb-15px d-inline-block"
                  >TrustScore</span
                >
              </figcaption>
            </figure>
